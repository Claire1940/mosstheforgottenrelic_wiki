...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Moss: The Forgotten Relic Wiki',
    description: 'Copyright and intellectual property information for Moss: The Forgotten Relic Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Moss: The Forgotten Relic Wiki',
      description: 'Copyright and intellectual property information for Moss: The Forgotten Relic Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Moss: The Forgotten Relic Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Moss: The Forgotten Relic Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Moss: The Forgotten Relic Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Moss: The Forgotten Relic Developers</strong> - Creators of the Moss: The Forgotten Relic game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Moss: The Forgotten Relic</strong> - Trademark of the game developers</li>
              <li><strong>Moss: The Forgotten Relic Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Moss: The Forgotten Relic Wiki.
            </p>
            ...
            <p>
              ...
              Moss: The Forgotten Relic Wiki<br />
              Email: <a href="mailto:dmca@mosstheforgottenrelic.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@mosstheforgottenrelic.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Moss: The Forgotten Relic Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Moss: The Forgotten Relic Wiki (mosstheforgottenrelic.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@mosstheforgottenrelic.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@mosstheforgottenrelic.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@mosstheforgottenrelic.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@mosstheforgottenrelic.wiki</a>
            </p>
            <p>
