...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.mosstheforgottenrelic.wiki'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'Moss: The Forgotten Relic Wiki'
